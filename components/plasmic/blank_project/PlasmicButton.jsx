...
import sty from "./PlasmicButton.module.css"; // plasmic-import: zoVuEjclQYu/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: r24BLGAZrIL/icon
import Icon3Icon from "./icons/PlasmicIcon__Icon3"; // plasmic-import: yvYX_C0m_5y/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg___7Km8H)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon3Icon
                className={classNames(projectcss.all, sty.svg__zHets)}
                role={"img"}
              />
            ),
